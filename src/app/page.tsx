      ...
      <main>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6">
          <div className="crt-border">
            ...
            <h3>Воркшоп</h3>
            <p>
              Первый открытый воркшоп для тех, кто хочет понять, как работает AI и почему он не страшный, а мощный
          ...
          <div className="crt-border">
            ...
            <h3>Воркшоп</h3>
            <p>Воркшоп для тех, кто хочет создавать крутое искусство при помощи нейросетей.</p>
            <br></br>
